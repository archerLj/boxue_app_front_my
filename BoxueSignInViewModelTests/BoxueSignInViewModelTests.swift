...
class BoxueSignInViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let guideContainer = BoxueGuideDependencyContainer(appDependencyContainer: appContainer)
    ...
    func testEmailTextFieldDiabledAfterSignInButtonPressed() {
